 ...
 * -----                                                                       *
 * Last Modified: 2023-04-12 10:42:49 am                                       *
...
trait CheeseParamsP32AB1V000 extends CheeseParams {
  // ******************************
  //            GLOBAL
  // ******************************
  def debug: Boolean  
...
case class CheeseConfigP32AB1V000 (    
  debug: Boolean
) extends CheeseParamsP32AB1V000

object CheeseP32AB1V000 extends App {
  (new chisel3.stage.ChiselStage).emitVerilog(new Cheese(new CheeseConfigP32AB1V000(debug = false)), args)
}
